            ...
            <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-full">
                ...
                <div className="flex items-center gap-4">
                    <div className="hidden md:flex flex-col items-end mr-2">
                        <span className="text-sm font-medium text-slate-200">{user?.user_metadata?.name || 'User'}</span>
                        <span className="text-xs text-slate-500">{user?.user_metadata?.role || 'Student'}</span>
                    </div>
