...
const DashboardHeader = React.memo(({ onMenuClick }: { onMenuClick: () => void }) => {
    ...
    return (
        <header className="sticky top-0 z-30 bg-[#030712] border-b border-white/[0.04] h-16 shadow-lg">
            <motion.div
                ...
                className="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-full will-change-transform"
                variants={containerVariants}
                initial="hidden"
                animate="visible"
            >
                <div className="flex items-center gap-4">
                    <motion.div variants={dropItemVariants} className="will-change-transform">
                        <button
                            onClick={onMenuClick}
                ...
                <div className="flex items-center gap-4 ml-auto">
                    <motion.div variants={dropItemVariants} className="hidden md:flex flex-col items-end mr-2 will-change-transform">
