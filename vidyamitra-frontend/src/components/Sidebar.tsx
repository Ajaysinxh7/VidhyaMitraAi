...
const navGroups: NavGroup[] = [
    ...
    },
    {
        ...
        links: [
            ...
            { name: 'Resume Parser', path: '/resume-parser', icon: ScanSearch },
        ],
    },
    {
        label: 'Assessment',
...
const SidebarContent = React.memo(({ setIsOpen, currentPath, isMobile }: SidebarContentProps) => {
...
const Sidebar = React.memo(({ isOpen, setIsOpen }: { isOpen: boolean; setIsOpen: (val: boolean) => void }) => {
