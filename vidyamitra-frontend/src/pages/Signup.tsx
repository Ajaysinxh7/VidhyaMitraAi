        ...
        <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full max-w-lg">
                <div className="text-center mb-6">
                    ...
                    <p className="text-sm text-slate-400">Join thousands of tech professionals</p>
                </div>
                ...
                <div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl shadow-xl backdrop-blur-sm">
                    <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="w-full">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-2.5 pl-11 text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors text-sm"
                                    ...
                                    <div className="mt-[-10px] mb-2">
                                        <div className="flex gap-1 mb-1.5">
                                            {[1, 2, 3, 4, 5].map((level) => (
                                                <div
                                                    key={level}
                                                    className={`h-1 w-full rounded-full ${level <= strengthScore ? strengthColor : 'bg-slate-700'
                        ...
                        <button
                            ...
                            className="w-full mt-4 py-3 rounded-xl font-semibold text-white bg-blue-600 hover:bg-blue-700 disabled:bg-blue-600/50 disabled:cursor-not-allowed transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2"
                        >
                            {isLoading ? (
