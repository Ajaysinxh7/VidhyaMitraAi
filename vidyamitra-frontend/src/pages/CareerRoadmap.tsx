...
export default function CareerRoadmap() {
    ...
    if (!roadmap) {
        return (
            <div className="max-w-4xl mx-auto flex flex-col w-full h-full pt-10 pb-10 px-4 items-center justify-center animate-in fade-in duration-500">
                <div className="mb-6 text-center">
                    <div className="inline-flex items-center justify-center p-3 bg-orange-500/10 rounded-full mb-4 relative">
                ...
                <div className="w-full bg-slate-800/40 p-6 md:p-8 rounded-2xl border border-slate-700/50 shadow-2xl">
                    <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-3 bg-slate-900 border border-slate-700 rounded-xl focus:outline-none focus:border-orange-500 transition-colors text-base"
                        ...
                        {/* Error Message */}
                        {errorMessage && (
                            <div className="flex items-start gap-3 p-3 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 animate-in fade-in duration-300">
                        ...
                        <div className="w-full pt-2">
                            <button
                                ...
                                disabled={!goal.trim()}
                                className={`w-full py-3.5 rounded-xl font-bold text-base flex items-center justify-center gap-2 transition-all ${!goal.trim()
                    ...
                    {/* Pro Tip */}
                    <div className="mt-5 p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl flex items-start gap-3">
